package com.pet_projects.switter;

import com.pet_projects.switter.controller.MessageController;
...
public class MessageControllerTest {
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/p").string("fifth"))
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div[@data-id=10]").string("\n" +
                        "                #new one\n" +
                        "            "));
    }
}
